...
Connect to AIRA client via SSH as described [here](../../AIRA/aira-connecting-via-ssh). All tutorials are pre-installed. To launch the ros package run the following command:
