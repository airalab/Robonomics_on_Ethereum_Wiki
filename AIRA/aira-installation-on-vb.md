...
![Host Only](./images/host_only_adapter.jpg "Host Only")

Then go to the image's settings, Network and add the second network adapter

![Second adapter](./images/add_second_adapter.jpg "Second adapter")
