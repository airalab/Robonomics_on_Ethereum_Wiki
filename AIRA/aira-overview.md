...
The most simple way to get familiar with AIRA is to try installing AIRA as a [virtual machine](./aira-installation-on-vb/).
...
Besides at the first launch AIRA [generates](./aira-installation-on-vb#launch-the-machine) for you new Ethereum address and IPNS identifier.
